...
{
    public partial class AssetIdentityDbContext:IdentityDbContext<ApplicationUser>
    {
        public AssetIdentityDbContext(DbContextOptions<AssetIdentityDbContext> options) : base(options)
        {
        }
